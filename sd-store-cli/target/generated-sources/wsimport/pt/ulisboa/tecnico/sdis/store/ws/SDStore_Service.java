 ...
 * 
 */
@WebServiceClient(name = "SDStore", targetNamespace = "urn:pt:ulisboa:tecnico:sdis:store:ws", wsdlLocation = "http://localhost:8080/store-ws/endpoint?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/store-ws/endpoint?WSDL");
